            ...
            <div className="container mx-auto">
                <div className="flex flex-col md:flex-row gap-12 justify-center items-center">
                    <div className="flex flex-col md:w-[52rem] space-y-8 md:px-8">
                        <Slide direction="left" cascade damping={0.6} duration={500}>
                            <Image 
                    ...
                    <Fade cascade delay={800} damping={0.2}>
                        <div className="flex flex-col justify-center text-black md:px-8">
                            ...
                            <h1 className="md:w-[60%] leading-[1.4] text-3xl font-style md:text-4xl lg:text-4xl text-maroon font-medium mb-6">
